...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:25px;">Hello!</span><br /><span style="font-size:10px;"><strong>This is how it works:</strong><br />1. Drag a ball.<br />拖动一个球。<br />2.&nbsp;Click&nbsp;on&nbsp;the&nbsp;background.<br />点击背景。<br />3. Shake your browser.<br />摇晃浏览器。（移动端无法实现）<br />4. Double click.<br />双击<br />5. Play!<br />玩</span>';
